...
class Train:
    def __init__(self,root):
        ...
        title_lbl=Label(self.root,text="TRAIN DATA SET", font=("Algerian",25,"bold"),bg="white",fg="red")
        title_lbl.place(x=0,y=0,width=1530,height=45)

        #top image
        img_top=Image.open(r"images/14.jpg")
        ...
        #bottom image
        img_bottom=Image.open(r"images/28.jpg")
